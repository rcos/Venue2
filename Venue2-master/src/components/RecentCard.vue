<template>
  ...
  <div class="card">
    <div class="card_image">
      <img src="../assets/demo.jpeg" alt="Demo Image" aria-label="Demo Image"/>
      </div>
...
<style>
:root {
  --card-background: DarkGray;
  --card-shadow1: rgba(0,0,0,0.25);
  --card-shadow2: rgba(0,0,0,0.22);
  --card-title-light: white;
  --card-title-dark: black;
}
.card {
  margin: 30px auto;
  width: 250px;
