  ...
  <div>
    ...
    <table class="table table-hover">
      ...
      <div
        ...
        role="status"
        v-if="!events_and_users_have_loaded"
      >
      ...
      <tbody v-else>
        <tr v-for="submission in submissions" :key="submission._id">
          ...
          <td>
            <router-link
              :to="{ name: 'edit_submission', params: { id: submission._id } }"
          ...
          <td>
            <button
              ...
              @click.prevent="deleteSubmission(submission._id)"
            >
              Delete
            </button>
          </td>
...
export default {
  ...
  methods: {
    ...
    async deleteSubmission(id) {
      ...
      this.submissions.splice(
        this.submissions.findIndex(i => i._id == id),
        1
      );
    }
    // setIsCourseView() {
