  ...
  <div>
    ...
    <div class="row">
      <div class="col-md-6">
        <form @submit.prevent="updateEvent">
          ...
          <div class="row" v-else>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input
                  class="form-control"
                  v-model="event.section.course.name"
                  readonly
                />
                <input
                  class="form-control"
                  v-model="event.section.name"
                  readonly
                />
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div v-if="event.geofence">
                  <ul>
                    <li v-for="point in event.geofence" :key="point">
                      {{ point.lat }},{{ point.lng }}
                    </li>
                  </ul>
                </div>
          ...
          <div class="form-group">
            <button class="btn btn-primary" v-on:click="updateEvent()">
              Update
            </button>
          </div>
        </form>
    ...
    <table class="table table-hover">
      ...
      <div
        ...
        role="status"
        v-if="!event_submissions_have_loaded"
      >
        <span class="sr-only">Loading...</span>
      </div>
      <tbody v-else>
