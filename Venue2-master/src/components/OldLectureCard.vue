<template>
  <div
    class="active-event-card-container"
    v-bind:class="{
  ...
  >
    <router-link
      ...
      :aria-label="'Lecture Info - ' + courseName + ' - ' + lecture.title"
    >
      ...
      <div class="active-event-card">
        ...
        <div
          v-if="eventSublabel != undefined && eventSublabel != ''"
          class="event-card-section event-section"
        >
        ...
        <div class="event-card-section" id="time-section">
          <div>
            ...
            <div class="time-remaining">
              <span v-if="status == 'pending'" class="pending-text"
                >pending</span
              >
...
export default {
  ...
  methods: {
    getTimeString(time_string) {
      if (time_string == "" || time_string == undefined || time_string == null)
        return "";
