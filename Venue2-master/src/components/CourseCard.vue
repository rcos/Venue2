<template>
  <div class="course_card_container">
    <div v-if="is_instructor">
      <router-link
        class="course_card_link"
        :to="
          is_instructor
            ? { name: 'course_info', params: { id: course._id } }
            : { name: 'course_info', params: { id: section._id } }
        "
        :aria-label="
          'Course Info - ' +
            course.name +
      ...
      >
        <div v-if="mobile" class="course-card-mobile">
          ...
          <div class="course-info">
            ...
            <div v-if="course.name.length > 21" class="course-name">
    ...
    <div v-else>
      ...
      >
        <div v-if="mobile" class="course-card-mobile">
          ...
          <div class="course-info">
            <div class="course-title">
              {{ section.course.dept }} {{ section.course.course_number }}-{{
                section.name
              }}
            </div>
            <div v-if="section.course.name.length > 21" class="course-name">
              {{ section.course.name.substring(0, 18) + "..." }}
            </div>
