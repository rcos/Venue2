  ...
  <div>
      ...
      <div v-if="is_live">
        <div v-if="submissions_with_live.length > 0">
          <div
            ...
            v-for="(submission, i) in submissions_with_live"
            :key="i"
          >
            <div class="namecard">
              <p>
      ...
      <div v-else-if="is_playback">
        <div v-if="submissions_with_playback.length > 0">
          <div
            ...
            v-for="(submission, i) in submissions_with_playback"
            :key="i"
          >
            <div class="namecard">
              <p>
      ...
      <div v-else-if="is_absent">
        <div v-if="submissions_with_nothing.length > 0">
          <div
            ...
            v-for="(absentee, i) in submissions_with_nothing"
            :key="i"
          >
            <div class="namecard">
              <p>
                {{ absentee.submitter.first_name }}
                {{ absentee.submitter.last_name }}
              </p>
    ...
    <div v-else>
      <div v-if="is_live">
        <div
          v-if="
            submissions_with_live[0] && submissions_with_live[0].live_percent
          "
        >
          <div class="namecard-edging live-color">
            <div class="namecard">
              ...
              <p>
                {{
                  getPrettyDateTimeWithMS(
                    new Date(submissions_with_live[0].live_submission_time)
                  )
                }}
              </p>
      ...
      <div v-else-if="is_playback">
        <div
          v-if="
            submissions_with_playback[0] &&
              submissions_with_playback[0].video_percent
          "
        >
            ...
            <div class="namecard">
              ...
              <p>
                {{
                  getPrettyDateTimeWithMS(
                    new Date(
                      submissions_with_playback[0].playback_submission_time
                    )
                  )
                }}
              </p>
