  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="time-info-container">
        ...
        <h4 class="time-info">
          Submission Start time: {{ new Date(event.submission_start_time) }}
        </h4>
        <h4 class="time-info">
          Submission End time: {{ new Date(event.submission_end_time) }}
        </h4>
      </div>
      <!-- geo fence -->
      <div>
      ...
      <div class="submission-status">
        ...
        <div v-else>
          ...
          <div v-else-if="event_is_active">
            ...
            <p v-if="submission_window_pending">Submission Window pending</p>
            <button v-else-if="submission_window_ongoing" @click="scanQR">
              Scan Code
            </button>
            <p v-else>Submission window closed</p>
          </div>
