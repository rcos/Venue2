...
DEFAULT_CONFIG_NOTES = {
    "use_config": """# Use Config determines whether or not the script should use the values provided in this document.
    ...
    for i in lines:
        if 'use_config:' in i.lower() and one_var in i.lower():
            ...
            if (mode != 'w'): 
                ...
                vars_written.append('cross_origin')
        else:
            f.write(i + '\n')
            ...
            if file_data:
                ...
                for i in variables:
                    if i not in variables_replaced:
                        variables_replaced.append(mend(i + ':', 'a'))
...
if __name__ == "__main__":
    ...
    # TODO More options?
    # TODO make error variables access mend with 'write' instead of append
