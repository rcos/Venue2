			...
			.then(res => {
				...
				if(localStorage.getItem('last_webex')) {
					...
					if(process.env.NODE_ENV === 'production') {
						window.location.href="https://webexapis.com/v1/authorize?client_id=C51b03a19e18dfd8ccb12e33224fd60be29d1554641b22aeb6b3c2cccad97d04d&response_type=code&redirect_uri=https%3A%2F%venue-meetings.com&scope=spark%3Aall%20spark%3Akms&state=venue_state"
					} else {
