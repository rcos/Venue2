<template>
  <div>
    ...
    <StudentLectureAttendanceTable :lecture="lecture" />
  </div>
</template>
...
<script>
  ...
  import StudentLectureAttendanceTable from '@/components/StudentLectureAttendanceTable.vue';
