<template>
  <div :class="'course-info-title ' + (this.mobileMode ? 'mobile' : '')">
    ...
    <div>
      ...
      <!-- Time Block -->
      <div v-if="course.hasOwnProperty('name') && section_name != -1"><div v-if="mobileMode && is_instructor" class="icon-spacer"/> Section {{ section_name }} <button class="btn" title="Delete Course" id="delete-course" @click="handleDeleteCourse()" v-if="is_instructor"><img class="red-x" id="delete-course" src="@/assets/icons8-delete.svg" alt="Delete" width="40" aria-label="Delete"></button></div>
