								...
								User.findById(student_id, function(err, student) {
									if(err || student == null) {
										...
										if(process.env.NODE_ENV === "production") {
											myhtml = '<p>New Lecture available for playback <a href="https://venue-meetings.com/#/lecture_playback/' + updated_lecture._id + '">here</a>!</p>'
										} else {
				...
				Lecture.findByIdAndUpdate(lecture._id,
					...
					function(err, lect) {
						if (err || lect == null) {
							...
							let myhtml = ""
							if(process.env.NODE_ENV === "production") {
								myhtml = '<p>Click <a href="https://venue-meetings.com/#/lecture_info/' + lect._id + '">here</a> to upload your lecture recording</p>'
							} else {
